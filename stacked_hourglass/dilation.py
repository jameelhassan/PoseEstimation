'''
Alternative implementation of HourglassNet focusing on Dilation experiments
'''
import torch
...
# Add a dep sep 3x3 conv with dilation = 4
...
# 3 3x3 dep sep convs with dilation = 1,2,3 in parallel
...
# 2 3x3 dilated conv with d=2
class Dilated(nn.Module):
    expansion = 2

    def __init__(self, inplanes, planes, stride=1, downsample=None,
                 dilation=3, residual=True):
