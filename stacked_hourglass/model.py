...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, separable=True):
        ...
        self.conv2 = SeparableConv2D(planes, planes, kernel_size=3, stride=stride, padding=1, bias=True) \
            if separable else nn.Conv2d(planes, planes, kernel_size=3, stride=stride,
                               padding=1, bias=True)
...
class HourglassNet(nn.Module):
    ...
    def __init__(self, block, num_stacks=2, num_blocks=4, num_classes=16):
        ...
        self.inplanes = 64  # Edit from 64
        self.num_feats = 128 # Edit from 128
